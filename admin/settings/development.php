...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configcheckbox('perfdebugdisplay', new lang_string('perfdebugdisplay', 'admin'), new lang_string('configperfdebugdisplay', 'admin'), 0));
    $temp->add(new admin_setting_configcheckbox('perfdebuglog', new lang_string('perfdebuglog', 'admin'), new lang_string('configperfdebuglog', 'admin'), 0));
